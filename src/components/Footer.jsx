...
//   };
//   return (
//     <footer className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300 flex text-xs z-40">
//       {/* Satellite Button */}
//       <button
//         onClick={() => {
...
//           // navigate("/DashboardPage");
//         }}
//         className={`w-1/2 flex flex-col items-center justify-center py-2 hover:cursor-pointer ${selected === "DashboardPage" ? "text-green-600 font-bold" : "text-gray-500"
//           }`}
//       >
//         <MdSatelliteAlt className="text-xl mb-1" />
//         उपग्रह प्रतिमा
//       </button>
...
//           // navigate("/ForecastTable");
//         }}
//         className={`w-1/2 flex flex-col items-center justify-center py-2 hover:cursor-pointer ${selected === "ForecastTable" ? "text-green-600 font-bold" : "text-gray-500"
//           }`}
//       >
//         <div className="flex space-x-1 mb-1">
//           <WiDayCloudy className="text-xl" />
//           <MdOutlinePestControl className="text-xl" />
//         </div>
//         हवामान, कीड व रोगांचे अंदाज
//       </button>
//     </footer>
//   );
// };
